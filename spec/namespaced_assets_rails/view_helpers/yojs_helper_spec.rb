...
describe NamespacedAssetsRails::Helpers::YojsHelper do
  let(:helper) { Class.new(ActionView::Base) do
      include NamespacedAssetsRails::Helpers #need javascript_ready
    end.new
  }
  ...
  describe "load_yojs" do
    ...
    specify do
      ...
      NamespacedAssetsRails::Helpers::YojsHelper::YojsCallGenerator.should_receive(:new).with("nomecontroller", "nomeaction", {:app_name => 'app_teste'}).and_return(generator_mock)
